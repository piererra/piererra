/* ============================================================
   gtasa-vehicles-data.js — GTA SA Save Editor · Vehicle Reference
   Author  : Piererra
   Project : Piererra Tools
   ──────────────────────────────────────────────────────────
   Source: GTAMods Wiki, "List of vehicles (SA)" (CC-BY 4.0).
   Model IDs 400-611 (212 vehicles).
============================================================ */

'use strict';

const ptSAE_VEHICLE_NAMES = {
  400: 'Landstalker', 401: 'Bravura', 402: 'Buffalo', 403: 'Linerunner', 404: 'Perennial',
  405: 'Sentinel', 406: 'Dumper', 407: 'Fire Truck', 408: 'Trashmaster', 409: 'Stretch',
  ...
  435: 'Article Trailer 1', 436: 'Previon', 437: 'Coach', 438: 'Cabbie', 439: 'Stallion',
  ...
  470: 'Patriot', 471: 'Quadbike', 472: 'Coastguard', 473: 'Dinghy', 474: 'Hermes',
  ...
  540: 'Vincent', 541: 'Bullet', 542: 'Clover', 543: 'Sadler', 544: 'Fire Truck (LA)',
  ...
  570: 'Brown Streak (Cargo)', 571: 'Kart', 572: 'Mower', 573: 'Dune', 574: 'Sweeper',
  575: 'Broadway', 576: 'Tornado', 577: 'AT-400', 578: 'DFT-30', 579: 'Huntley',
  580: 'Stafford', 581: 'BF-400', 582: 'Newsvan', 583: 'Tug', 584: 'Petrol Truck',
  ...
  595: 'Launch', 596: 'Police (LS)', 597: 'Police (SF)', 598: 'Police (LV)', 599: 'Ranger',
  600: 'Picador', 601: 'S.W.A.T.', 602: 'Alpha', 603: 'Phoenix', 604: 'Glendale (Damaged)',
  605: 'Sadler (Damaged)', 606: 'Bag Box A', 607: 'Bag Box B', 608: 'Tug Stairs', 609: 'Boxville (Burgershot)',
  610: 'Farm Trailer', 611: 'Utility Trailer'
};

window.ptSAE_VEHICLE_NAMES = ptSAE_VEHICLE_NAMES;
